...
def prompt_api_confirmation(
    ...
    print(f"{Fore.GREEN if COLORAMA_AVAILABLE else ''}New Path:     {new_path}{Style.RESET_ALL if COLORAMA_AVAILABLE else ''}")
