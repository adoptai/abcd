...
from wdl_common.interactive import print_error, print_success
...
def run_quick_test(
    ...
    # Execute
    try:
        result = client.run_action(tool_id, test_prompt, conversation_history=[], timeout=60)
...
def run_full_test(
    ...
    for i, prompt in enumerate(test_prompts):
        ...
        try:
            output = client.run_action(tool_id, prompt, conversation_history=[], timeout=60)
...
""",
    ...
    parser.add_argument(
        "--generate-instruction", action="store_true", help="Generate AI instruction on failure"
    )
